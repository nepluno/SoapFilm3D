...
VS3D * Scenes::sceneSphere(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
...
VS3D * Scenes::sceneTet(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
...
VS3D * Scenes::sceneCube(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
...
VS3D * Scenes::sceneSheet(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
    ...
    int buf[] = {1, 26, 13, 29, 2, 30, 15, 32, 3, 33, 16, 35, 4, 36, 17, 38, 5, 39, 18, 42, 6, 41, 14, 27};
...
VS3D * Scenes::sceneBarrel(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
    int M = Options::intValue("mesh-size-m");
...
VS3D * Scenes::sceneDoubleBubble(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
    int M = Options::intValue("mesh-size-m");
...
VS3D * Scenes::sceneTwoBubbles(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
...
VS3D * Scenes::sceneTripleJunction(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
...
VS3D * Scenes::sceneFoamInit(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    ...
    for (int i = 0; i < M; i++)
    {
        ...
        {
            Vec3d c = Vec3d(2.0 * rand() / RAND_MAX - 1.0, 2.0 * rand() / RAND_MAX - 1.0, 2.0 * rand() / RAND_MAX - 1.0);
...
VS3D * Scenes::sceneFoam(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    sim->m_load_directory = Options::strValue("load-dir");
    assert(sim->m_load_directory != "");
    
    VS3D * tmp_vs = new VS3D(std::vector<LosTopos::Vec3d>(), std::vector<LosTopos::Vec3st>(), std::vector<LosTopos::Vec2i>());
...
VS3D * Scenes::sceneQuadJunction(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
...
VS3D * Scenes::sceneConstrainedSphere(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
//    int M = Options::intValue("mesh-size-m");
...
VS3D * Scenes::sceneBubbleWand(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
...
VS3D * Scenes::sceneTwoRingsPinching(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
...
VS3D * Scenes::scenePullingFoam(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    sim->m_load_directory = Options::strValue("load-dir");
    assert(sim->m_load_directory != "");
...
//        cv.push_back(right_order[i].first);
    ...
    for (size_t i = 0; i < last_ring.size(); i++)
    {
        ...
        {
            Vec3d n = (vs3d->pos(last_ring[i]) - lr_center).cross(vs3d->pos(last_ring[j]) - lr_center);
...
//    constrained_vertices.erase(std::remove(constrained_vertices.begin(), constrained_vertices.end(), 1331), constrained_vertices.end());
//    constrained_vertices.erase(std::remove(constrained_vertices.begin(), constrained_vertices.end(), 168), constrained_vertices.end());
//    constrained_vertices.erase(std::remove(constrained_vertices.begin(), constrained_vertices.end(), 764), constrained_vertices.end());
//    constrained_vertices.erase(std::remove(constrained_vertices.begin(), constrained_vertices.end(), 1406), constrained_vertices.end());
//    constrained_vertices.erase(std::remove(constrained_vertices.begin(), constrained_vertices.end(), 729), constrained_vertices.end());
//    constrained_vertices.erase(std::remove(constrained_vertices.begin(), constrained_vertices.end(), 797), constrained_vertices.end());
//    constrained_vertices.erase(std::remove(constrained_vertices.begin(), constrained_vertices.end(), 2485), constrained_vertices.end());
    ...
    for (size_t i = 0; i < cv.size(); i++)
        vs3d->m_st->m_masses[cv[i]] = LosTopos::Vec3d(1, 1, 1) * std::numeric_limits<double>::infinity();

    return vs3d;
}

VS3D * Scenes::scenePeanutBubble(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
    int M = Options::intValue("mesh-size-m");
...
VS3D * Scenes::sceneStraw(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
...
VS3D * Scenes::sceneCarousel(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
    int M = Options::intValue("mesh-size-m");
...
VS3D * Scenes::sceneOctahedron(Sim * sim, std::vector<LosTopos::Vec3d> & vs, std::vector<LosTopos::Vec3st> & fs, std::vector<LosTopos::Vec2i> & ls, std::vector<size_t> & cv, std::vector<Vec3d> & cx)
{
    int N = Options::intValue("mesh-size-n");
...
void Scenes::stepFoamInit(double dt, Sim * sim, VS3D * vs)
{
    ...
    for (size_t i = 0; i < vs->mesh().nv(); i++)
    {
        ...
        vs->surfTrack()->pm_newpositions[i] = vs->surfTrack()->pm_positions[i] + dt * alpha * vc(displacement[i]);
    }
...
void Scenes::stepFoam(double dt, Sim * sim, VS3D * vs)
{
    ...
    if (sim->m_time > s_next_burst)
    {
        ...
        for (std::set<int>::iterator Bi = Bs.begin(); Bi != Bs.end(); Bi++)
        {
            ...
            double mean_Gamma_0B = 0;  // mean_Gamma_0B stores the mean of Gammas for region pair (0, B) on the triple junction between (0, B) and (A, B)
            double mean_Gamma_AB = 0;  // mean_Gamma_0A stores the mean of Gammas for region pair (A, B) on the triple junction between (0, B) and (A, B)
            int mean_counter = 0;
            for (size_t i = 0; i < vs->mesh().nv(); i++)
            {
            ...
            for (size_t i = 0; i < vs->mesh().nv(); i++)
            {
                ...
                if (incident_to_0B && incident_to_AB)
                {
                    (*vs->m_Gamma)[i].set(0, B, ((*vs->m_Gamma)[i].get(0, B) + (*vs->m_Gamma)[i].get(A, B)) / 2);
        ...
        for (size_t i = 0; i < vs->mesh().nt(); i++)
        {
            ...
            if (l[0] == region_to_burst || l[1] == region_to_burst)
            {
                ...
                if (lother == 0)
                    ...
                    vs->mesh().set_triangle_label(i, (l[0] == region_to_burst ? LosTopos::Vec2i(0, l[1]) : LosTopos::Vec2i(l[0], 0)));
            }
        }
...
void Scenes::stepTwoRingsPinching(double dt, Sim * sim, VS3D * vs)
{
    if (sim->m_time < 5)
        for (size_t i = 0; i < vs->m_constrained_vertices.size(); i++)
            vs->m_constrained_positions[i] += Vec3d((vs->m_constrained_positions[i].x() > 0 ? 1 : -1), 0, 0) * 0.04 * dt;
}
...
void Scenes::stepPullingFoam(double dt, Sim * sim, VS3D * vs)
{
    ...
    for (size_t i = 0; i < vs->m_constrained_vertices.size(); i++)
        vs->m_constrained_positions[i] += (vs->m_constrained_positions[i].x() > 0 ? 1 : -1) * dir * 0.02 * dt;
}
