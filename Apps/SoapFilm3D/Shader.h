...
//      1.0.1   4/7/2013    added an integer verion of setUniform, useful for
...
class Shader {
 ...
 public:
  ...
  static void setUniform(const std::string& name, const Mat3& m,
                         bool transpose = false);
  static void setUniform(const std::string& name, const Mat4& m,
                         bool transpose = false);
 ...
 protected:
  void printProgramInfoLog(GLuint prog, const std::string& name,
                           const std::string& stage);
  void printShaderInfoLog(GLuint shader, const std::string& name,
                          const std::string& stage);
