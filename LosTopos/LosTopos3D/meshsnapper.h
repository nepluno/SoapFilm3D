...
class MeshSnapper {
 public:
  ...
  ///
  MeshSnapper(SurfTrack& surf, bool use_curvature, bool remesh_boundaries,
              int max_curvature_multiplier);
 ...
 private:
  ...
  /// Snap threshold (how close to a vertex/edge to revert to lower dimensional
  /// element snapping This examines the barycentric coordinates of a closest
  /// point, and if below this threshold, snaps to a vertex or edge.
  ...
  ///
  bool snap_pseudo_motion_introduces_collision(
  ...
  ///
  bool face_vertex_pair_is_snappable(size_t vert0, size_t vert1,
                                     double& cur_length);
