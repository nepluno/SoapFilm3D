...
// ---------------------------------------------------------
///
/// Edge splitter object.  Splits "long" edges by introducing a new vertex at
/// the midpoint, optionally offsetting for curvature preservation.
///
// ---------------------------------------------------------
...
class EdgeSplitter {
 public:
  /// Constructor
  ///
  EdgeSplitter(SurfTrack& surf, bool use_curvature, bool remesh_boundaries,
 ...
 private:
  ...
  /// the existing mesh.
  ///
  bool split_edge_pseudo_motion_introduces_intersection(
 ...
 public:
  ...
  ///
  bool split_edge(
      size_t edge, size_t& result_vert, bool ignore_bad_angles = false,
      bool specify_split_position = false, Vec3d const* pos = 0,
      const std::vector<size_t>& ignore_vertices = std::vector<size_t>(),
      bool ignore_min_length = false);
};
