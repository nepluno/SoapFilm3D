...
// ---------------------------------------------------------
///
/// Mesh pincher object.  Identifies "singular vertices", defined as having more
/// than one connected triangle neighbourhoods, and splits the mesh surface at
/// these vertices.
///
// ---------------------------------------------------------
...
class MeshPincher {
 public:
  ...
  /// Constructor
  ///
  MeshPincher(SurfTrack& surf) : m_surf(surf) {}
 ...
 private:
  ...
  ///
  void partition_vertex_neighbourhood(
  ...
  ///
  bool pull_apart_vertex(size_t vertex_index,
