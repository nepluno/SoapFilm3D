...
// ---------------------------------------------------------
///
/// Mesh rendering object.  Contains current rendering options and functions for
/// doing OpenGL render of a mesh.
///
// ---------------------------------------------------------
...
class MeshRenderer {
 public:
  ...
  /// Display the specified geometry in OpenGL using the current options
  /// settings
  ///
  void render(const std::vector<Vec3d>& xs, const std::vector<Vec3d>& normals,
