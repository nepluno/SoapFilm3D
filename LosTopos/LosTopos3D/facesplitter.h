...
//
//  Functions supporting the "face split" operation: subdivide face into three
//  triangles
//
// ---------------------------------------------------------
...
// ---------------------------------------------------------
///
/// Face splitter object.  Splits a face into three triangles via a new vertex
/// in the middle of it.
///
// ---------------------------------------------------------
...
class FaceSplitter {
 ...
 private:
  ...
  /// the existing mesh.
  ///
  bool split_face_pseudo_motion_introduces_intersection(
 ...
 public:
  ...
  ///
  bool split_face(size_t face, size_t& result_vert, bool specify_point = false,
                  Vec3d const* subd_point = 0);
};
