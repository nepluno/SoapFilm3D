...
// class Interval:
//
// Stores the interval [a,b] as [-a,b] internally.  With proper arithmetic
// operations, this allows us to use only FE_UPWARD and avoid switching rounding
// modes over and over.
//
// ----------------------------------------
...
inline double Interval::stored_left() const { return v[0]; }

// ----------------------------------------

inline double Interval::stored_right() const { return v[1]; }
