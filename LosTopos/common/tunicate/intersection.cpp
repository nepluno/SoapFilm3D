...
static int simplex_intersection2d(int k, const double* x0, const double* x1,
                                  const double* x2, double* alpha0,
                                  double* alpha1, double* alpha2) {
  assert(k == 1);
  // try projecting each coordinate out in turn
  double ax0, ax1, ax2;
  if (!simplex_intersection1d(1, x0 + 1, x1 + 1, x2 + 1, &ax0, &ax1, &ax2))
    return 0;
  double ay0, ay1, ay2;
...
int simplex_intersection2d(int k, const double* x0, const double* x1,
  ...
  switch (k) {
    ...
    case 3:  // triangle vs. point
      return simplex_intersection2d(1, x3, x2, x1, x0, alpha3, alpha2, alpha1,
                                    alpha0);
    default:
...
static int simplex_intersection3d(int k, const double* x0, const double* x1,
  ...
  if (!simplex_intersection2d(k, x0 + 1, x1 + 1, x2 + 1, x3 + 1, &ax0, &ax1,
                              &ax2, &ax3))
    return 0;
  double ay0, ay1, ay2, ay3;
  double p0[2] = {x0[0], x0[2]}, p1[2] = {x1[0], x1[2]}, p2[2] = {x2[0], x2[2]},
         p3[2] = {x3[0], x3[2]};
...
int simplex_intersection3d(int k, const double* x0, const double* x1,
  ...
  switch (k) {
      ...
      *alpha0 = 1;
      ...
      if (sum2) {
        ...
        *alpha4 /= sum2;
        ...
        if (simplex_intersection3d(1, x0, x2, x3, x4, alpha0, alpha2, alpha3,
                                   alpha4)) {
          *alpha1 = 0;
          return 1;
        }
        if (simplex_intersection3d(1, x0, x1, x3, x4, alpha0, alpha1, alpha3,
                                   alpha4)) {
          *alpha2 = 0;
          return 1;
        }
        if (simplex_intersection3d(1, x0, x1, x2, x4, alpha0, alpha1, alpha2,
                                   alpha4)) {
          *alpha3 = 0;
          return 1;
        }
        if (simplex_intersection3d(1, x0, x1, x2, x3, alpha0, alpha1, alpha2,
                                   alpha3)) {
          *alpha4 = 0;
          return 1;
        }
      ...
      *alpha4 = orientation3d(x0, x1, x2, x3);
      ...
      if (sum1 && sum2) {
        ...
        *alpha4 /= sum2;
        ...
        if (simplex_intersection3d(1, x1, x2, x3, x4, alpha1, alpha2, alpha3,
                                   alpha4)) {
          *alpha0 = 0;
          return 1;
        }
        ...
        if (simplex_intersection3d(2, x0, x1, x3, x4, alpha0, alpha1, alpha3,
                                   alpha4)) {
          *alpha2 = 0;
          return 1;
        }
        if (simplex_intersection3d(2, x0, x1, x2, x4, alpha0, alpha1, alpha2,
                                   alpha4)) {
          *alpha3 = 0;
          return 1;
        }
        if (simplex_intersection3d(2, x0, x1, x2, x3, alpha0, alpha1, alpha2,
                                   alpha3)) {
          *alpha4 = 0;
          return 1;
        }
    ...
    case 4:  // tetrahedron vs. point
      return simplex_intersection3d(5 - k, x4, x3, x2, x1, x0, alpha4, alpha3,
...
static int simplex_intersection_time3d(
    int k, const double* x0, int time0, const double* x1, int time1,
    const double* x2, int time2, const double* x3, int time3, const double* x4,
    int time4, double* alpha0, double* alpha1, double* alpha2, double* alpha3,
    double*) {
  assert(k <= 2);
  ...
  double r0[3] = {x0[0], x0[2], static_cast<double>(time0)},
         r1[3] = {x1[0], x1[2], static_cast<double>(time1)},
         r2[3] = {x2[0], x2[2], static_cast<double>(time2)},
         r3[3] = {x3[0], x3[2], static_cast<double>(time3)},
         r4[3] = {x4[0], x4[2], static_cast<double>(time4)};
  if (!simplex_intersection3d(k, r0, r1, r2, r3, r4, &ax0, &ax1, &ax2, &ax3,
                              &ax4))
    return 0;
  double ay0, ay1, ay2, ay3, ay4;
  double p0[3] = {x0[0], x0[2], static_cast<double>(time0)},
         p1[3] = {x1[0], x1[2], static_cast<double>(time1)},
         p2[3] = {x2[0], x2[2], static_cast<double>(time2)},
         p3[3] = {x3[0], x3[2], static_cast<double>(time3)},
         p4[3] = {x4[0], x4[2], static_cast<double>(time4)};
  if (!simplex_intersection3d(k, p0, p1, p2, p3, p4, &ay0, &ay1, &ay2, &ay3,
                              &ay4))
    return 0;
  double az0, az1, az2, az3, az4;
  double q0[3] = {x0[0], x0[1], static_cast<double>(time0)},
         q1[3] = {x1[0], x1[1], static_cast<double>(time1)},
         q2[3] = {x2[0], x2[1], static_cast<double>(time2)},
         q3[3] = {x3[0], x3[1], static_cast<double>(time3)},
         q4[3] = {x4[0], x4[1], static_cast<double>(time4)};
  if (!simplex_intersection3d(k, q0, q1, q2, q3, q4, &az0, &az1, &az2, &az3,
                              &az4))
    return 0;
  double at0, at1, at2, at3, at4;
  if (!simplex_intersection3d(k, x0, x1, x2, x3, x4, &at0, &at1, &at2, &at3,
                              &at4))
    return 0;
  // decide which solution is more accurate for barycentric coordinates
  ...
  if (k == 1) {
    checkx = std::fabs(-ax0 * x0[0] + ax1 * x1[0] + ax2 * x2[0] + ax3 * x3[0] +
             ...
             std::fabs(-ax0 * x0[2] + ax1 * x1[2] + ax2 * x2[2] + ax3 * x3[2] +
                       ax4 * x4[2]) +
             std::fabs(-ax0 * time0 + ax1 * time1 + ax2 * time2 + ax3 * time3 +
                       ax4 * time4);
    checky = std::fabs(-ay0 * x0[0] + ay1 * x1[0] + ay2 * x2[0] + ay3 * x3[0] +
                       ay4 * x4[0]) +
             std::fabs(-ay0 * x0[1] + ay1 * x1[1] + ay2 * x2[1] + ay3 * x3[1] +
             ...
             std::fabs(-ay0 * x0[2] + ay1 * x1[2] + ay2 * x2[2] + ay3 * x3[2] +
                       ay4 * x4[2]) +
             std::fabs(-ay0 * time0 + ay1 * time1 + ay2 * time2 + ay3 * time3 +
                       ay4 * time4);
    checkz = std::fabs(-az0 * x0[0] + az1 * x1[0] + az2 * x2[0] + az3 * x3[0] +
                       az4 * x4[0]) +
             std::fabs(-az0 * x0[1] + az1 * x1[1] + az2 * x2[1] + az3 * x3[1] +
             ...
             std::fabs(-az0 * x0[2] + az1 * x1[2] + az2 * x2[2] + az3 * x3[2] +
                       az4 * x4[2]) +
             std::fabs(-az0 * time0 + az1 * time1 + az2 * time2 + az3 * time3 +
                       az4 * time4);
    checkt = std::fabs(-at0 * x0[0] + at1 * x1[0] + at2 * x2[0] + at3 * x3[0] +
                       at4 * x4[0]) +
             std::fabs(-at0 * x0[1] + at1 * x1[1] + at2 * x2[1] + at3 * x3[1] +
                       at4 * x4[1]) +
             std::fabs(-at0 * x0[2] + at1 * x1[2] + at2 * x2[2] + at3 * x3[2] +
                       at4 * x4[2]) +
             std::fabs(-at0 * time0 + at1 * time1 + at2 * time2 + at3 * time3 +
                       at4 * time4);
  } else {
    checkx = std::fabs(-ax0 * x0[0] - ax1 * x1[0] + ax2 * x2[0] + ax3 * x3[0] +
                       ax4 * x4[0]) +
...
//==============================================================================
int simplex_intersection_time3d(int k, const double* x0, int t0,
                                const double* x1, int t1, const double* x2,
                                int t2, const double* x3, int t3,
                                const double* x4, int t4, const double* x5,
                                int t5, double* alpha0, double* alpha1,
  ...
  switch (k) {
      ...
      *alpha5 = -orientation_time3d(x0, t0, x1, t1, x2, t2, x3, t3, x4, t4);
      ...
      if (sum2) {
        ...
        *alpha5 /= sum2;
        ...
        if (simplex_intersection_time3d(1, x0, t0, x2, t2, x3, t3, x4, t4, x5,
                                        t5, alpha0, alpha2, alpha3, alpha4,
                                        alpha5)) {
          *alpha1 = 0;
          return 1;
        }
        if (simplex_intersection_time3d(1, x0, t0, x1, t1, x3, t3, x4, t4, x5,
                                        t5, alpha0, alpha1, alpha3, alpha4,
                                        alpha5)) {
          *alpha2 = 0;
          return 1;
        }
        if (simplex_intersection_time3d(1, x0, t0, x1, t1, x2, t2, x4, t4, x5,
                                        t5, alpha0, alpha1, alpha2, alpha4,
                                        alpha5)) {
          *alpha3 = 0;
          return 1;
        }
        if (simplex_intersection_time3d(1, x0, t0, x1, t1, x2, t2, x3, t3, x5,
                                        t5, alpha0, alpha1, alpha2, alpha3,
                                        alpha5)) {
          *alpha4 = 0;
          return 1;
        }
        if (simplex_intersection_time3d(1, x0, t0, x1, t1, x2, t2, x3, t3, x4,
                                        t4, alpha0, alpha1, alpha2, alpha3,
                                        alpha4)) {
          *alpha5 = 0;
          return 1;
        }
      ...
      *alpha5 = -orientation_time3d(x0, t0, x1, t1, x2, t2, x3, t3, x4, t4);
      ...
      if (sum1 && sum2) {
        ...
        *alpha5 /= sum2;
        ...
        if (simplex_intersection_time3d(1, x1, t1, x2, t2, x3, t3, x4, t4, x5,
                                        t5, alpha1, alpha2, alpha3, alpha4,
                                        alpha5)) {
          *alpha0 = 0;
          return 1;
        }
        ...
        if (simplex_intersection_time3d(2, x0, t0, x1, t1, x3, t3, x4, t4, x5,
                                        t5, alpha0, alpha1, alpha3, alpha4,
                                        alpha5)) {
          *alpha2 = 0;
          return 1;
        }
        if (simplex_intersection_time3d(2, x0, t0, x1, t1, x2, t2, x4, t4, x5,
                                        t5, alpha0, alpha1, alpha2, alpha4,
                                        alpha5)) {
          *alpha3 = 0;
          return 1;
        }
        if (simplex_intersection_time3d(2, x0, t0, x1, t1, x2, t2, x3, t3, x5,
                                        t5, alpha0, alpha1, alpha2, alpha3,
                                        alpha5)) {
          *alpha4 = 0;
          return 1;
        }
        if (simplex_intersection_time3d(2, x0, t0, x1, t1, x2, t2, x3, t3, x4,
                                        t4, alpha0, alpha1, alpha2, alpha3,
                                        alpha4)) {
          *alpha5 = 0;
          return 1;
      ...
      *alpha5 = -orientation_time3d(x0, t0, x1, t1, x2, t2, x3, t3, x4, t4);
      ...
      if (sum1 && sum2) {
        ...
        *alpha5 /= sum2;
        ...
        if (simplex_intersection_time3d(2, x1, t1, x2, t2, x3, t3, x4, t4, x5,
                                        t5, alpha1, alpha2, alpha3, alpha4,
                                        alpha5)) {
          *alpha0 = 0;
          return 1;
        }
        if (simplex_intersection_time3d(2, x0, t0, x2, t2, x3, t3, x4, t4, x5,
                                        t5, alpha0, alpha2, alpha3, alpha4,
                                        alpha5)) {
          *alpha1 = 0;
          return 1;
        ...
        if (simplex_intersection_time3d(2, x4, t4, x5, t5, x0, t0, x1, t1, x2,
                                        t2, alpha4, alpha5, alpha0, alpha1,
                                        alpha2)) {
          *alpha3 = 0;
          return 1;
        }
        if (simplex_intersection_time3d(2, x3, t3, x5, t5, x0, t0, x1, t1, x2,
                                        t2, alpha3, alpha5, alpha0, alpha1,
                                        alpha2)) {
          *alpha4 = 0;
          return 1;
        }
        if (simplex_intersection_time3d(2, x3, t3, x4, t4, x0, t0, x1, t1, x2,
                                        t2, alpha3, alpha4, alpha0, alpha1,
                                        alpha2)) {
          *alpha5 = 0;
          return 1;
        }
    ...
    case 5:  // pentachoron vs. point
      return simplex_intersection_time3d(6 - k, x5, t5, x4, t4, x3, t3, x2, t2,
                                         x1, t1, x0, t0, alpha5, alpha4, alpha3,
                                         alpha2, alpha1, alpha0);
    default:
      return -1;  // should never get here
  }
...
static int simplex_intersection4d(int k, const double* x0, const double* x1,
                                  const double* x2, const double* x3,
                                  const double* x4, double* alpha0,
                                  double* alpha1, double* alpha2,
                                  double* alpha3, double*) {
  assert(k <= 2);
  // try projecting each coordinate out in turn
  double ax0, ax1, ax2, ax3, ax4;
  if (!simplex_intersection3d(k, x0 + 1, x1 + 1, x2 + 1, x3 + 1, x4 + 1, &ax0,
                              &ax1, &ax2, &ax3, &ax4))
    return 0;
  double ay0, ay1, ay2, ay3, ay4;
  ...
  if (k == 1) {
    checkx = std::fabs(-ax0 * x0[0] + ax1 * x1[0] + ax2 * x2[0] + ax3 * x3[0] +
             ...
             std::fabs(-ax0 * x0[2] + ax1 * x1[2] + ax2 * x2[2] + ax3 * x3[2] +
                       ax4 * x4[2]) +
             std::fabs(-ax0 * x0[3] + ax1 * x1[3] + ax2 * x2[3] + ax3 * x3[3] +
                       ax4 * x4[3]);
    checky = std::fabs(-ay0 * x0[0] + ay1 * x1[0] + ay2 * x2[0] + ay3 * x3[0] +
                       ay4 * x4[0]) +
             std::fabs(-ay0 * x0[1] + ay1 * x1[1] + ay2 * x2[1] + ay3 * x3[1] +
             ...
             std::fabs(-ay0 * x0[2] + ay1 * x1[2] + ay2 * x2[2] + ay3 * x3[2] +
                       ay4 * x4[2]) +
             std::fabs(-ay0 * x0[3] + ay1 * x1[3] + ay2 * x2[3] + ay3 * x3[3] +
                       ay4 * x4[3]);
    checkz = std::fabs(-az0 * x0[0] + az1 * x1[0] + az2 * x2[0] + az3 * x3[0] +
                       az4 * x4[0]) +
             std::fabs(-az0 * x0[1] + az1 * x1[1] + az2 * x2[1] + az3 * x3[1] +
             ...
             std::fabs(-az0 * x0[2] + az1 * x1[2] + az2 * x2[2] + az3 * x3[2] +
                       az4 * x4[2]) +
             std::fabs(-az0 * x0[3] + az1 * x1[3] + az2 * x2[3] + az3 * x3[3] +
                       az4 * x4[3]);
    checkt = std::fabs(-at0 * x0[0] + at1 * x1[0] + at2 * x2[0] + at3 * x3[0] +
                       at4 * x4[0]) +
             std::fabs(-at0 * x0[1] + at1 * x1[1] + at2 * x2[1] + at3 * x3[1] +
             ...
             std::fabs(-at0 * x0[2] + at1 * x1[2] + at2 * x2[2] + at3 * x3[2] +
                       at4 * x4[2]) +
             std::fabs(-at0 * x0[3] + at1 * x1[3] + at2 * x2[3] + at3 * x3[3] +
                       at4 * x4[3]);
  } else {
    checkx = std::fabs(-ax0 * x0[0] - ax1 * x1[0] + ax2 * x2[0] + ax3 * x3[0] +
                       ax4 * x4[0]) +
...
int simplex_intersection4d(int k, const double* x0, const double* x1,
  ...
  switch (k) {
      ...
      *alpha5 = -orientation4d(x0, x1, x2, x3, x4);
      ...
      if (sum2) {
        ...
        *alpha5 /= sum2;
        ...
        if (simplex_intersection4d(1, x0, x2, x3, x4, x5, alpha0, alpha2,
                                   alpha3, alpha4, alpha5)) {
          *alpha1 = 0;
          return 1;
        }
        if (simplex_intersection4d(1, x0, x1, x3, x4, x5, alpha0, alpha1,
                                   alpha3, alpha4, alpha5)) {
          *alpha2 = 0;
          return 1;
        }
        if (simplex_intersection4d(1, x0, x1, x2, x4, x5, alpha0, alpha1,
                                   alpha2, alpha4, alpha5)) {
          *alpha3 = 0;
          return 1;
        }
        if (simplex_intersection4d(1, x0, x1, x2, x3, x5, alpha0, alpha1,
                                   alpha2, alpha3, alpha5)) {
          *alpha4 = 0;
          return 1;
        }
        if (simplex_intersection4d(1, x0, x1, x2, x3, x4, alpha0, alpha1,
      ...
      *alpha5 = -orientation4d(x0, x1, x2, x3, x4);
      ...
      if (sum1 && sum2) {
        ...
        *alpha5 /= sum2;
        ...
        if (simplex_intersection4d(1, x1, x2, x3, x4, x5, alpha1, alpha2,
                                   alpha3, alpha4, alpha5)) {
          *alpha0 = 0;
          return 1;
        }
        ...
        if (simplex_intersection4d(2, x0, x1, x3, x4, x5, alpha0, alpha1,
                                   alpha3, alpha4, alpha5)) {
          *alpha2 = 0;
          return 1;
        }
        if (simplex_intersection4d(2, x0, x1, x2, x4, x5, alpha0, alpha1,
                                   alpha2, alpha4, alpha5)) {
          *alpha3 = 0;
          return 1;
        }
        if (simplex_intersection4d(2, x0, x1, x2, x3, x5, alpha0, alpha1,
                                   alpha2, alpha3, alpha5)) {
          *alpha4 = 0;
          return 1;
        }
        if (simplex_intersection4d(2, x0, x1, x2, x3, x4, alpha0, alpha1,
                                   alpha2, alpha3, alpha4)) {
          *alpha5 = 0;
          return 1;
        }
      ...
      *alpha5 = -orientation4d(x0, x1, x2, x3, x4);
      ...
      if (sum1 && sum2) {
        ...
        *alpha5 /= sum2;
        ...
        if (simplex_intersection4d(2, x1, x2, x3, x4, x5, alpha1, alpha2,
                                   alpha3, alpha4, alpha5)) {
          *alpha0 = 0;
          return 1;
        }
        if (simplex_intersection4d(2, x0, x2, x3, x4, x5, alpha0, alpha2,
                                   alpha3, alpha4, alpha5)) {
          *alpha1 = 0;
          return 1;
        }
        ...
        if (simplex_intersection4d(2, x4, x5, x0, x1, x2, alpha4, alpha5,
                                   alpha0, alpha1, alpha2)) {
          *alpha3 = 0;
          return 1;
        }
        if (simplex_intersection4d(2, x3, x5, x0, x1, x2, alpha3, alpha5,
                                   alpha0, alpha1, alpha2)) {
          *alpha4 = 0;
          return 1;
        }
        if (simplex_intersection4d(2, x3, x4, x0, x1, x2, alpha3, alpha4,
                                   alpha0, alpha1, alpha2)) {
          *alpha5 = 0;
          return 1;
        }
    ...
    case 4:  // tetrahedron vs. segment
    case 5:  // pentachoron vs. point
      return simplex_intersection4d(6 - k, x5, x4, x3, x2, x1, x0, alpha5,
