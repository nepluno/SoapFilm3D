...
inline bool IntervalBase::certainly_opposite_sign(
    const IntervalBase& other) const {
...
inline bool IntervalBase::same_sign(const IntervalBase& other) const {
  return (this->indefinite_sign() || other.indefinite_sign() ||
...
inline bool certainly_opposite_sign(const IntervalBase& a,
                                    const IntervalBase& b) {
