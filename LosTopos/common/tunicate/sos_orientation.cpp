...
void sort_points(int& priority0, const double*& x0, int& priority1,
                 const double*& x1, double& sign) {
  if (priority0 < priority1) {
...
double sos_orientation2d(int priority0, const double* x0, int priority1,
  ...
  assert(priority0 != priority1 && priority0 != priority2 &&
         priority1 != priority2);
...
double sos_orientation3d(int priority0, const double* x0, int priority1,
  ...
  // row 1
  double c0[2] = {x0[0], x0[2]}, c1[2] = {x1[0], x1[2]}, c2[2] = {x2[0], x2[2]},
         c3[2] = {x3[0], x3[2]};
...
double sos_orientation4d(int priority0, const double* x0, int priority1,
  ...
  assert(priority0 != priority1 && priority0 != priority2 &&
         priority0 != priority3);
  assert(priority0 != priority4 && priority1 != priority2 &&
         priority1 != priority3);
  assert(priority1 != priority4 && priority2 != priority3 &&
         priority2 != priority4);
  ...
  // row 1
  double c0[3] = {x0[0], x0[2], x0[3]}, c1[3] = {x1[0], x1[2], x1[3]},
         c2[3] = {x2[0], x2[2], x2[3]}, c3[3] = {x3[0], x3[2], x3[3]},
         c4[3] = {x4[0], x4[2], x4[3]};
  ...
  if (d < 0)
    ...
    return -sign * dbl_min;
  double b0[2] = {x0[0], x0[3]}, b1[2] = {x1[0], x1[3]}, b2[2] = {x2[0], x2[3]},
         b3[2] = {x3[0], x3[3]}, b4[2] = {x4[0], x4[3]};
  ...
  // row 3
  return sign * sos_orientation3d(priority1, x1, priority2, x2, priority3, x3,
                                  priority4, x4);
}
