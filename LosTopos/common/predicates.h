...
//======================================================================================================
// double precision floating point versions; they err on the side of safety
// (indicate collision when it's too close to tell for sure, or exactly touches)
//======================================================================================================

// x0 is the point, x1-x2 is the segment. Take care to specify x1,x2 in sorted
// order of index!
...
// x0 is the point, x1-x2-x3 is the triangle. Take care to specify x1,x2,x3 in
...
// x0 is the point, x1-x2-x3 is the triangle. Take care to specify x1,x2,x3 in
// sorted order of index! If there is a collision, returns true and sets bary1,
// bary2, bary3 to the barycentric coordinates of the collision point, sets
// normal to the collision point, t to the collision time, and the relative
...
bool fe_point_triangle_collision(
    ...
    double& relative_normal_displacement, bool verbose = false);

// x0-x1 and x2-x3 are the segments. Take care to specify x0,x1 and x2,x3 in
// sorted order of index!
...
// x0-x1 and x2-x3 are the segments. Take care to specify x0,x1 and x2,x3 in
// sorted order of index! If there is a collision, returns true and sets bary0
// and bary2 to parts of the barycentric coordinates of the collision point,
// sets normal to the collision point, t to the collision time, and the relative
