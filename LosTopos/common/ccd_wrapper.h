...
bool segment_segment_intersection(const Vec2d& x0, size_t index0,
                                  const Vec2d& x1, size_t index1,
                                  const Vec2d& x2, size_t index2,
                                  const Vec2d& x3, size_t index3, double& s0,
                                  double& s2);
...
bool segment_triangle_intersection(
    ...
    const Vec3d& x4, size_t index4, double& bary0, double& bary1, double& bary2,
    double& bary3, double& bary4, bool degenerate_counts_as_intersection,
    bool verbose = false);
