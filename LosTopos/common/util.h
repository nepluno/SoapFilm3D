...
inline S bicubic_interp(const S& v00, const S& v10, const S& v20, const S& v30,
  ...
  return cubic_interp(cubic_interp(v00, v10, v20, v30, fx),
                      ...
                      cubic_interp(v03, v13, v23, v33, fx), fy);
}

template <class S, class T>
inline S tricubic_interp(const Array3<S, Array1<S> >& v, int i, int j, int k,
                         T fx, T fy, T fz) {
  return cubic_interp(
      bicubic_interp(v(i + 0, j + 0, k + 0), v(i + 1, j + 0, k + 0),
                     v(i + 2, j + 0, k + 0), v(i + 3, j + 0, k + 0),
                     v(i + 0, j + 1, k + 0), v(i + 1, j + 1, k + 0),
                     v(i + 2, j + 1, k + 0), v(i + 3, j + 1, k + 0),
                     v(i + 0, j + 2, k + 0), v(i + 1, j + 2, k + 0),
                     v(i + 2, j + 2, k + 0), v(i + 3, j + 2, k + 0),
                     v(i + 0, j + 3, k + 0), v(i + 1, j + 3, k + 0),
                     v(i + 2, j + 3, k + 0), v(i + 3, j + 3, k + 0), fx, fy),
      bicubic_interp(v(i + 0, j + 0, k + 1), v(i + 1, j + 0, k + 1),
                     v(i + 2, j + 0, k + 1), v(i + 3, j + 0, k + 1),
                     v(i + 0, j + 1, k + 1), v(i + 1, j + 1, k + 1),
                     v(i + 2, j + 1, k + 1), v(i + 3, j + 1, k + 1),
                     v(i + 0, j + 2, k + 1), v(i + 1, j + 2, k + 1),
                     v(i + 2, j + 2, k + 1), v(i + 3, j + 2, k + 1),
                     v(i + 0, j + 3, k + 1), v(i + 1, j + 3, k + 1),
                     v(i + 2, j + 3, k + 1), v(i + 3, j + 3, k + 1), fx, fy),
      bicubic_interp(v(i + 0, j + 0, k + 2), v(i + 1, j + 0, k + 2),
                     v(i + 2, j + 0, k + 2), v(i + 3, j + 0, k + 2),
                     v(i + 0, j + 1, k + 2), v(i + 1, j + 1, k + 2),
                     v(i + 2, j + 1, k + 2), v(i + 3, j + 1, k + 2),
                     v(i + 0, j + 2, k + 2), v(i + 1, j + 2, k + 2),
                     v(i + 2, j + 2, k + 2), v(i + 3, j + 2, k + 2),
                     v(i + 0, j + 3, k + 2), v(i + 1, j + 3, k + 2),
                     v(i + 2, j + 3, k + 2), v(i + 3, j + 3, k + 2), fx, fy),
      bicubic_interp(v(i + 0, j + 0, k + 3), v(i + 1, j + 0, k + 3),
                     v(i + 2, j + 0, k + 3), v(i + 3, j + 0, k + 3),
                     v(i + 0, j + 1, k + 3), v(i + 1, j + 1, k + 3),
                     v(i + 2, j + 1, k + 3), v(i + 3, j + 1, k + 3),
                     v(i + 0, j + 2, k + 3), v(i + 1, j + 2, k + 3),
                     v(i + 2, j + 2, k + 3), v(i + 3, j + 2, k + 3),
                     v(i + 0, j + 3, k + 3), v(i + 1, j + 3, k + 3),
                     v(i + 2, j + 3, k + 3), v(i + 3, j + 3, k + 3), fx, fy),
      fz);
}
